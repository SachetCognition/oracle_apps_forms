...
@Component({
    ...
    <div class="form-container">
      <mat-card>
        <mat-card-header>
          ...
          <mat-card-title>Manager Login</mat-card-title>
          <mat-card-subtitle>Sign in to access the administrative portal</mat-card-subtitle>
        </mat-card-header>
        <mat-card-content>
  ...
  styles: [`
    ...
    .header-icon { color: #009688; font-size: 28px; width: 28px; height: 28px; margin-right: 12px; }
...
export class ManagerLoginComponent {
  ...
  onSubmit(): void {
    ...
    this.authService.managerLogin(this.form.value).subscribe({
      next: () => {
